    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_ing_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_ing_add" class="form form-horizontal"
                                            action="controllers/ingrediants.php" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-actions text-center">
                                                        ...
                                                        <input type="hidden" id="btnAddIng" name="btnAddIng"
                                                            value="btnAddIng">
                                                        <button type="button" class="btn btn-primary"
                                                            id="btn_ing_Add" name="btn_ing_Add"
