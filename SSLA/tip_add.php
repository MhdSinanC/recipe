    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_tip_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_tip_add" class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="tip">Cooking
                                                                Tip</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="image">Tip
                                                                Image</label>
                                                            <div class="col-md-9 mx-auto">
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddCookingTip" name="btnAddCookingTip"
                                                        value="btnAddCookingTip">
                                                    <button type="button" class="btn btn-primary" id="btn_tip_Add"
                                                        name="btn_tip_Add" onclick="return validateForm()">
