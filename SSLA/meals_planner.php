    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_mealplanner_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_mealplanner_add" class="form form-horizontal"
                                            action="controllers/mealplanner.php" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="name">Meal
                                                                Name</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="type">Meal
                                                                Type</label>
                                                            <div class="col-md-9 mx-auto">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control"
                                                                for="cooking_time">Cooking Time (in minutes)</label>
                                                            <div class="col-md-9 mx-auto">
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddMealPlanner" name="btnAddMealPlanner"
                                                        value="btnAddMealPlanner">
                                                    <button type="button" class="btn btn-primary" id="btn_mealplanner_Add"
                                                        name="btn_mealplanner_Add" onclick="return validateForm()">
