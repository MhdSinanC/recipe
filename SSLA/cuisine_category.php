    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_category_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_category_add" class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="image">Category
                                                                Image</label>
                                                            <div class="col-md-9 mx-auto">
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddCategory" name="btnAddCategory"
                                                        value="btnAddCategory">
                                                    <button type="button" class="btn btn-primary" id="btn_category_Add"
                                                        name="btn_category_Add" onclick="return validateForm()">
