                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form id="form_meal_add" class="form form-horizontal"
                                            action="controllers/mealtype.php" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="name">Meal Type
                                                                Name</label>
                                                ...
                                                <!-- Hidden Fields for Created and Updated Timestamps -->
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddMealType" name="btnAddMealType"
                                                        value="btnAddMealType">
                                                    <button type="button" class="btn btn-primary" id="btn_mealtype_Add"
                                                        name="btn_mealtype_Add" onclick="return validateForm()">
