    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_cuisine_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_cuisine_add" class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="title">Cuisine
                                                                Name</label>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <select class="select2-theme form-control"
                                                                    ...
                                                                    // Check if there are any categories and populate the options
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="image">Cuisine
                                                                Image</label>
                                                            <div class="col-md-9 mx-auto">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="number" id="calories" name="calories"
                                                                    class="form-control border-primary"
                                                                    placeholder="Enter calories" min="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <input type="number" id="cooking_time" name="cooking_time"
                                                                    class="form-control border-primary"
                                                                    placeholder="Enter cooking time" min="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                       </div>
                                            ...
                                            <div class="form-actions text-center">
                                                ...
                                                <input type="hidden" id="btnAddCuisine" name="btnAddCuisine"
                                                    value="btnAddCuisine">
                                                <button type="button" class="btn btn-primary" id="btn_cuisine_Add"
                                                    name="btn_cuisine_Add" onclick="return validateForm()">
