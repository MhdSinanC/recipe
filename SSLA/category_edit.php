...
<head>
    ...
    <script>
        function validateUpdateForm() {
            ...
            document.getElementById('form_category_edit').addEventListener('submit', function (event) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        document.getElementById('form_category_edit').submit(); // Submit the form using JavaScript
                    }
                    else {
                        return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form id="form_category_edit" class="form form-horizontal"
                                            action="controllers/category.php" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="name">Category
                                                                Name *</label>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                <select id="status" name="status"
                                                                    ...
                                                                    <option value="active" <?php echo (isset($category['status']) && $category['status'] === 'active') ? 'selected' : ''; ?>>Active</option>
                                                                    <option value="inactive" <?php echo (isset($category['status']) && $category['status'] === 'inactive') ? 'selected' : ''; ?>>Inactive</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 mx-auto">
                                                                ...
                                                                <input type="hidden" name="existing_image"
                                                                    value="<?php echo isset($category['image']) ? $category['image'] : ''; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    </div>
                                                    ...
                                                    <div class="form-actions text-center">
                                                        ...
                                                        <input type="hidden" id="btnCategoryUpdate"
                                                            name="btnCategoryUpdate" value="btnCategoryUpdate">
