            ...
            <div class="content-body">
                ...
                <section id="configuration">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered dataex-res-configuration">
                                            ...
                                            <tbody>
                                                <?php
                                                // Query to fetch meals data
                                                $query = "SELECT * FROM meals_planner";
                    ...
                    <td class='d-flex align-items-center'>
                        <a class='btn btn-primary mr-1' href='meal_edit.php?id={$row['id']}'>
                            <i class='la la-edit'></i>
                        </a>
                        <form id='meal_form_view_{$row['id']}' method='post' action='controllers/mealplanner.php' class='mb-0'>
                            <input type='hidden' name='btnMealDelete' value='btnMealDelete'>
                            <input type='hidden' name='id_ref' value='{$row['id']}'>
                            <button type='button' class='btn btn-danger mr-1' onclick='return validateMealDelete({$row['id']}, `{$row['name']}`)'>
