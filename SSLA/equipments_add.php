    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_eqp_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_eqp_add" class="form form-horizontal"
                                            action="controllers/equipments.php" method="post"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control" for="name">Equipment
                                                                Name</label>
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddEquipment" name="btnAddEquipment"
                                                        value="btnAddEquipment">
                                                    <button type="button" class="btn btn-primary" id="btn_equipment_Add"
                                                        name="btn_equipment_Add" onclick="return validateForm()">
