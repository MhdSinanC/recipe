...
<head>
    ...
    <script>
        function validateForm(reference_id, ref_name) {
            var tip_form_view_ = "tip_form_view_" + reference_id;
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById(tip_form_view_).submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                }
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Tips Data</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="tip_add.php">Tips</a></li>
                                <li class="breadcrumb-item active">Tips Data</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <section id="configuration">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tips View</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered dataex-res-configuration">
                                            ...
                                            <tbody>
                                                <?php
                                                // Query to fetch cooking tips data
                                                $query = "SELECT * FROM cooking_tips";
                        ...
                        <a href='../uploads/{$row['image']}' download>
                            <img src='../uploads/{$row['image']}' alt='Tip Image' style='width:50px;height:50px;'>
                        </a>
                        </td>
                        ...
                        <td class='d-flex align-items-center'>
                            <a class='btn btn-primary mr-1' href='tip_edit.php?id={$row['id']}'>
                                <i class='la la-edit'></i>
                            </a>
                            <form id='tip_form_view_{$row['id']}' method='post' action='controllers/tip.php' class='mb-0'>
                                <input type='hidden' id='btn_cooking_tip_delete' name='btn_cooking_tip_delete' value='btn_cooking_tip_delete'>
                                <input type='hidden' id='id_ref' name='id_ref' value='{$row['id']}'>
                                <button type='button' id='delete_button_{$row['id']}' class='btn btn-danger mr-1' onclick='return validateForm({$row['id']}, `{$row['tip']}`)'>
