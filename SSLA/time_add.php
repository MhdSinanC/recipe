    ...
    <script>
        function validateForm() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    document.getElementById('form_time_add').submit(); // Submit the form using JavaScript
                }
                else {
                    return false;
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form id="form_time_add" class="form form-horizontal"
                                            action="controllers/time.php" method="post"
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 label-control"
                                                                for="time_range">Cooking Time Range</label>
                                                ...
                                                <div class="form-actions text-center">
                                                    ...
                                                    <input type="hidden" id="btnAddCookingTime" name="btnAddCookingTime"
                                                        value="btnAddCookingTime">
                                                    <button type="button" class="btn btn-primary"
                                                        id="btn_cookingtime_Add" name="btn_cookingtime_Add"
