...
$(document).ready(function() {
    ...
    if (!$.fn.DataTable.isDataTable('.dataex-res-configuration')) {
        $('.dataex-res-configuration').DataTable({
            responsive: true,
            dom: 'Bfrtip', // Adding dom option for Bootstrap Table Export extension
            buttons: [
                'copy', 'csv', 'excel', 'pdf', 'print' // Adding export buttons
            ]
        });
